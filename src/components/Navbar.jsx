          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul className="navbar-nav me-end mb-2 mb-lg-0">
              <li className="nav-item order-lg-first order-last d-flex align-items-center my-3">
                <i className="fa-brands fa-lg mx-1 fa-tiktok"></i>
                <i className="fa-brands fa-lg mx-1 fa-linkedin"></i>
                <i className="fa-brands fa-lg mx-1 fa-github"></i>
                <i className="fa-brands fa-lg mx-1 fa-discord"></i>
              </li>
              {props.userData ? (
                <li className="nav-item">
